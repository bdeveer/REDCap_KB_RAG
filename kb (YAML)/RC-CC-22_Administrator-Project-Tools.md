...
synonyms:
- how do i view a project as a specific user
- impersonate a user to troubleshoot their access
- see what a user sees in a project as admin
- jump to a project by pid
- project switcher quick navigation
- admin troubleshooting tool for user rights
- reproduce a user issue without their password
- go directly to a project using project id
---
