---
id: RC-SURV-11
title: Accessibility in REDCap Surveys & Forms
domain: Surveys
applies_to:
- Survey and instrument designers
- anyone answering an institutional accessibility question about REDCap
requires: Varies by item — see §3. Most improvements land between 16.0.6 and 17.3.0
verified_against: REDCap v17.4.1 (Standard) / v17.3.7 (LTS) — changelog review. Assistive-technology
...
related:
- id: RC-SURV-02
  title: 'Survey Settings: Basic Options and Design'
- id: RC-SURV-03
  title: 'Survey Settings: Behavior, Access and Termination'
- id: RC-FD-06
  title: 'Online Designer: Instrument & Field Management'
- id: RC-MLM-01
...
- surveys
synonyms:
- is redcap accessible
- redcap screen reader support
- WCAG compliance redcap
- section 508 redcap surveys
- keyboard navigation surveys
- accessible surveys for participants with disabilities
- VoiceOver redcap
