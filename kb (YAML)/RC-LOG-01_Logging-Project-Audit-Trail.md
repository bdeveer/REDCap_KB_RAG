...
- logging
synonyms:
- how do i view the project audit trail
- who changed this data and when
- see a history of all actions in my project
- filter and export the logging records
- redcap audit log for compliance
- track record creation deletion and exports
- data history popup clock icon
- difference between logging and email logging
---
