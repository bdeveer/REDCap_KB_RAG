...
related:
- id: RC-NAV-UI-01
  title: 'Project Navigation UI, RC-NAV-UI-02 — Project Menu Reference, RC-PROJ-01
    — Project Lifecycle: Status and Settings, RC-PROJ-04 — Project Setup: Additional
    Customizations, RC-DAG-01 — Data Access Groups, RC-PIPE-03 — Smart Variables Overview,
