...
applies_to:
- All REDCap users
- REDCap Administrators (Sections 5–7)
...
- id: RC-API-44
  title: Export REDCap Version API
- id: RC-CC-23
...
synonyms:
- what redcap version am i running
- difference between redcap lts and standard
- should we use lts or standard redcap
- how often is redcap released
- what does long term support mean in redcap
- why is our redcap version number lower than another site
- how to read the redcap changelog
- how do i know if my redcap needs patching
- what redcap version introduced this feature
- redcap release schedule and upgrade cadence
---
