---
id: RC-EM-02
title: External Modules — Installed Module Catalog — Production Instance
domain: External Modules
applies_to:
- REDCap administrators
- project designers on the Production instance
...
- external modules
synonyms:
- which external modules are available on production
- list of installed modules on the production instance
- is a particular module installed here
- what modules can i enable for my project
- available external modules catalog
- production redcap module list
- find out if a module is installed
- modules approved for production use
---
