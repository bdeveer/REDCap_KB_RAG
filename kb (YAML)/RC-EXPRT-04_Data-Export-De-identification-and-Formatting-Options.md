...
- availability varies by Data Export Rights level
prerequisites:
...
- data
synonyms:
- how to deidentify exported data
- remove identifiers from my export
- export data without phi
- hide free text and dates on export
- shift dates for de-identification
- export formatting options explained
- mask identifying fields when downloading
- remove names and mrn from export
---
