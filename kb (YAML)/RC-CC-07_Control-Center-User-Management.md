...
synonyms:
- control center browse and manage user accounts
- system-level user account administration
- user allowlist to restrict redcap access
- email a filtered group of users
- manage api tokens across all projects
- edit a user account at the instance level
- control center users section tools
- find and edit user accounts admin
---
...
See [RC-API-01 — REDCap API](RC-API-01_REDCap-API.md) for a full overview of the REDCap API and how tokens are used.
