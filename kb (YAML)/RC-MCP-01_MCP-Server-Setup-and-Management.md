---
id: RC-MCP-01
title: 'REDCap MCP Server: Setup and Management'
domain: MCP
applies_to:
...
- mcp
synonyms:
- how do i set up the redcap mcp server
- connect claude to redcap
- register the mcp server with claude desktop
- model context protocol for redcap api
- let claude export records and query metadata
- configure multiple mcp servers for prod test and dev
- where is the mcp json config file
- install the redcap mcp python script
---
