...
- branching logic
synonyms:
- how do i use and or in branching logic
- combine multiple conditions in branching logic
- branching logic with parentheses
- show a field only if two answers are true
- multiple conditions for showing a field
- using or in redcap logic
- compound branching logic statement
- nesting and or conditions
---
