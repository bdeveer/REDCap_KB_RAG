...
- messenger
synonyms:
- how do i message another redcap user
- built-in chat for redcap
- start a group conversation in redcap
- send a secure direct message to a colleague
- share files with other users inside redcap
- is redcap messenger hipaa compliant
- archive or delete a conversation
- where do i find the messenger chat
---
