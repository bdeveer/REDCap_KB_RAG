...
*RC-NAV-UI-01 \| UI Layout & Navigation Concepts*
...
**5. Questions & Answers**
  ...
  ---------------------------------------------------------------------------- --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  *Why can\'t I see a menu item that my colleague can see?*                    Menu items are controlled by two things: (1) user rights assigned to your account for this project, and (2) whether the feature is enabled in the project setup. Both must be true for an item to appear.
  *Why does the menu look different in different projects?*                    Each project can have different features enabled and can assign different user rights. The menu always reflects the intersection of what is enabled and what your account is allowed to access.
  *How do I get back to the My Projects page from inside a project?*           Click the REDCap logo in the top-left of the menu, or click the My Projects link directly below it. Both take you to the same place.
  *What is hamburger mode and how do I get out of it?*                         Hamburger mode is a responsive layout that collapses the left menu when the browser window is too narrow. Widen your browser window or click the ☰ icon to restore the menu.
