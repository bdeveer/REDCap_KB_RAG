...
Every instrument ends with a standard REDCap completion status field
(the `_complete` field), shown as a dropdown with choices 0 = Incomplete,
1 = Unverified, 2 = Complete. This appears in the Codebook just like any
other field.
