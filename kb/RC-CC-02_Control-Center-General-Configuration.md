...
> **Administrator access required.** This page is only available to REDCap super users via the Control Center → System Configuration → General Configuration.
...
- RC-CC-07 — Users & Access Management (Banned IP Addresses)
