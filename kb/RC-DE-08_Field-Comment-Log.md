...
| **Synonyms** | how do i add a comment to a field; leave a note on a data value; field comment log how to use; annotate a field during data entry; where do field comments show up; add an explanatory note to a record value; comment on a specific data point; field-level notes and annotations |
